...
class NHLFT_Gui(tk.Frame):
    ...
    def images(self): #The background image loaded up
    ...
    def guide(self): #Guide for user briefly explaining
        Output="Guide"
    ...
    def combobox(self):
        ...
        # List of NHLFT s loaded into Combobox
        self._Combo['values']= NHLFT_Gui.NHLFT_S
    ...
    def combobox2(self):
        ...
        self._Combo2 = Combobox(self, textvariable=self._ComboValue2,
                                  ...
                                  justify = 'center', font=self.myfont)
        # List of NHLFT s loaded into Combobox
        self._Combo2['values']= NHLFT_Gui.Players
    ...
    def ok2(self,event):
        ...
        ADJUSTMENT=OF.FinalAdjustment(people,people2,people3,people4,people5,people6,people7
                                        ,Corsi,PDO,OZone,GOALS,ASSISTS,ShootingPercent)
